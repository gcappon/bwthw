...
import 'package:polar_to_csv/models/heart_rate_data.dart';
import 'package:polar_to_csv/screens/polar_settings_page.dart';
import 'package:polar_to_csv/widgets/line_plot.dart';
            ...
            ListTile(
              ...
              onTap: () {
                ...
                for (var element in heartRateData) {
                  times.add(DateFormat('yyyy-MM-dd HH:mm:ss').format(element.time));
                  hrs.add(element.value.toString());
                }
                listOfLists.add(times);
                listOfLists.add(hrs);
                exportCSV.myCSV(header, listOfLists, fileName: 'polar_session', setHeadersInFirstRow: true, transposeAfterRow: 1);
              },
            ),
          ],
        ),
